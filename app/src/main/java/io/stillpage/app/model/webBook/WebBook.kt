...
import io.stillpage.app.help.book.removeAllBookType
...
object WebBook {
    ...
    suspend fun getContentAwait(
        ...
        // 短剧特殊处理：如果章节URL为空，直接使用baseUrl获取内容
        val contentUrl = if (bookChapter.url.isEmpty() && book.isDrama) {
            Debug.log(bookSource.bookSourceUrl, "⇒短剧章节URL为空，使用baseUrl获取内容")
            bookChapter.baseUrl
        } else {
