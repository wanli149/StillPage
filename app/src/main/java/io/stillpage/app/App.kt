...
import io.stillpage.app.base.AppContextWrapper
import io.stillpage.app.constant.AppConst.channelIdDownload
import io.stillpage.app.constant.AppConst.channelIdReadAloud
import io.stillpage.app.constant.AppConst.channelIdWeb
...
import io.stillpage.app.data.entities.rule.BookInfoRule
import io.stillpage.app.data.entities.rule.ContentRule
import io.stillpage.app.data.entities.rule.ExploreRule
import io.stillpage.app.data.entities.rule.SearchRule
import io.stillpage.app.help.AppFreezeMonitor
import io.stillpage.app.help.AppWebDav
import io.stillpage.app.help.CrashHandler
import io.stillpage.app.help.DefaultData
import io.stillpage.app.help.LauncherIconHelp
import io.stillpage.app.help.LifecycleHelp
import io.stillpage.app.help.RuleBigDataHelp
import io.stillpage.app.help.book.BookHelp
import io.stillpage.app.help.config.AppConfig
import io.stillpage.app.help.config.ThemeConfig.applyDayNight
import io.stillpage.app.help.config.ThemeConfig.applyDayNightInit
import io.stillpage.app.help.coroutine.Coroutine
import io.stillpage.app.help.http.Cronet
import io.stillpage.app.help.http.ObsoleteUrlFactory
import io.stillpage.app.help.http.okHttpClient
import io.stillpage.app.help.rhino.NativeBaseSource
...
import io.stillpage.app.utils.ChineseUtils
import io.stillpage.app.utils.LogUtils
import io.stillpage.app.utils.defaultSharedPreferences
import io.stillpage.app.utils.getPrefBoolean
import io.stillpage.app.utils.isDebuggable
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        // 强制重置启动器组件状态以修复启动问题
        LauncherIconHelp.forceResetComponents()
