...
import io.stillpage.app.help.book.isLocalModified
...
import io.stillpage.app.utils.mapAsyncIndexed
...
import io.stillpage.app.utils.writeFile
...
class ExportBookService : BaseService() {
    ...
    private fun setEpubMetadata(book: Book, epubBook: EpubBook) {
        ...
        metadata.publishers.add("StillPage")//数据的创建者
