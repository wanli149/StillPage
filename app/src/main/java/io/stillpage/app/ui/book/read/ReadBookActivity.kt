...
import io.stillpage.app.data.entities.BookProgress
...
import io.stillpage.app.help.TTS
...
import io.stillpage.app.help.book.isEpub
import io.stillpage.app.help.book.isLocal
import io.stillpage.app.help.book.isLocalTxt
import io.stillpage.app.help.book.isMobi
...
import io.stillpage.app.help.config.ReadTipConfig
import io.stillpage.app.help.coroutine.Coroutine
import io.stillpage.app.help.source.getSourceType
...
import io.stillpage.app.model.analyzeRule.AnalyzeRule
import io.stillpage.app.model.analyzeRule.AnalyzeRule.Companion.setChapter
import io.stillpage.app.model.analyzeRule.AnalyzeRule.Companion.setCoroutineContext
import io.stillpage.app.model.localBook.EpubFile
import io.stillpage.app.model.localBook.MobiFile
import io.stillpage.app.receiver.NetworkChangedListener
import io.stillpage.app.receiver.TimeBatteryReceiver
import io.stillpage.app.service.BaseReadAloudService
import io.stillpage.app.ui.about.AppLogDialog
import io.stillpage.app.ui.book.bookmark.BookmarkDialog
import io.stillpage.app.ui.book.changesource.ChangeBookSourceDialog
import io.stillpage.app.ui.book.changesource.ChangeChapterSourceDialog
import io.stillpage.app.ui.book.info.BookInfoActivity
import io.stillpage.app.utils.startBookInfoActivity
import io.stillpage.app.ui.book.read.config.AutoReadDialog
import io.stillpage.app.ui.book.read.config.BgTextConfigDialog.Companion.BG_COLOR
import io.stillpage.app.ui.book.read.config.BgTextConfigDialog.Companion.TEXT_COLOR
import io.stillpage.app.ui.book.read.config.MoreConfigDialog
import io.stillpage.app.ui.book.read.config.ReadAloudDialog
import io.stillpage.app.ui.book.read.config.ReadStyleDialog
import io.stillpage.app.ui.book.read.config.TipConfigDialog.Companion.TIP_COLOR
import io.stillpage.app.ui.book.read.config.TipConfigDialog.Companion.TIP_DIVIDER_COLOR
import io.stillpage.app.ui.book.read.page.ContentTextView
import io.stillpage.app.ui.book.read.page.ReadView
import io.stillpage.app.ui.book.read.page.entities.PageDirection
import io.stillpage.app.ui.book.read.page.entities.TextPage
import io.stillpage.app.ui.book.read.page.provider.ChapterProvider
import io.stillpage.app.ui.book.read.page.provider.LayoutProgressListener
import io.stillpage.app.ui.book.searchContent.SearchContentActivity
import io.stillpage.app.ui.book.searchContent.SearchResult
import io.stillpage.app.ui.book.source.edit.BookSourceEditActivity
import io.stillpage.app.ui.book.toc.TocActivityResult
import io.stillpage.app.ui.book.toc.rule.TxtTocRuleDialog
import io.stillpage.app.ui.browser.WebViewActivity
import io.stillpage.app.ui.dict.DictDialog
...
import io.stillpage.app.utils.applyOpenTint
import io.stillpage.app.utils.buildMainHandler
import io.stillpage.app.utils.dismissDialogFragment
import io.stillpage.app.utils.getPrefBoolean
import io.stillpage.app.utils.getPrefString
import io.stillpage.app.utils.hexString
import io.stillpage.app.utils.iconItemOnLongClick
import io.stillpage.app.utils.invisible
import io.stillpage.app.utils.isAbsUrl
import io.stillpage.app.utils.isTrue
import io.stillpage.app.utils.launch
import io.stillpage.app.utils.navigationBarGravity
...
import io.stillpage.app.utils.sysScreenOffTime
import io.stillpage.app.utils.throttle
