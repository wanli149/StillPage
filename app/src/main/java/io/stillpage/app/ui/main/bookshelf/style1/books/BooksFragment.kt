package io.stillpage.app.ui.main.bookshelf.style1.books
...
import io.stillpage.app.databinding.FragmentBooksBinding
    ...
    private fun upRecyclerData() {
        ...
        booksFlowJob = viewLifecycleOwner.lifecycleScope.launch {
            appDb.bookDao.flowByGroup(groupId).map { list ->
                ...
                val displayList = if (io.stillpage.app.help.config.AppConfig.enableAdultContent) rawBooks else filtered
                binding.tvEmptyMsg.isGone = displayList.isNotEmpty()
                binding.refreshLayout.isEnabled = enableRefresh && displayList.isNotEmpty()
                booksAdapter.setItems(displayList)
                delay(100)
            }
        }
    }
