...
import io.stillpage.app.help.book.isNotShelf
import io.stillpage.app.help.book.isSameNameAuthor
import io.stillpage.app.help.book.isWebFile
import io.stillpage.app.help.book.removeType
import io.stillpage.app.help.book.updateTo
import io.stillpage.app.help.coroutine.Coroutine
import io.stillpage.app.lib.webdav.ObjectNotFoundException
...
class BookInfoViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun refreshBookData(book: Book) {
        execute {
            // 从数据库获取最新的书籍数据
            appDb.bookDao.getBook(book.bookUrl)?.let { updatedBook ->
                bookData.postValue(updatedBook)
            }
        }
    }
