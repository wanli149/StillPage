...
package io.stillpage.app.ui.widget.code
...
val stillPagePattern: Pattern = Pattern.compile("\\|\\||&&|%%|@js:|@Json:|@css:|@@|@XPath:")
...
fun CodeView.addStillPagePattern() {
    addSyntaxPattern(stillPagePattern, appCtx.color(R.color.md_orange_900))
}
