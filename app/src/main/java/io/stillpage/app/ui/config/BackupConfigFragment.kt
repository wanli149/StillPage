...
import io.stillpage.app.help.storage.BackupConfig
...
import io.stillpage.app.lib.permission.Permissions
import io.stillpage.app.lib.permission.PermissionsCompat
...
import io.stillpage.app.utils.toEditable
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<io.stillpage.app.lib.prefs.Preference>("web_dav_restore")
            ?.onLongClick {
                restoreFromLocal()
                true
            }
